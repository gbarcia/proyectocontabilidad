...
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (4, 1, 0, 15000, NULL, NULL, NULL, NULL, NULL, NULL, 'C');
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (4, 13, 15000, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'C');
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (5, 1, 400, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'V');
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (5, 10, 0, 400, NULL, NULL, NULL, NULL, NULL, NULL, 'V');
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (6, 1, 300, 0, NULL, NULL, NULL, NULL, NULL, NULL, 'V');
INSERT INTO `REGISTRO` (`ASIENTO_num`, `CUENTA_num`, `debe`, `haber`, `VENTA_id`, `VENTA_CLIENTE_rif`, `VENTA_PRODUCTO_id`, `COMPRA_id`, `COMPRA_PRODUCTO_id`, `COMPRA_PROVEEDOR_rif`, `tipo`)
VALUES (6, 11, 0, 300, NULL, NULL, NULL, NULL, NULL, NULL, 'V');
COMMIT;
